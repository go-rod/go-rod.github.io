...
If you run the "main.go" again, you should see a browser like this:
...
As you can see we only added one line before the screenshot.
...
If we rerun the "main.go", the "a.png" will show the search result:
...
Then rerun the "main.go", now every action now will wait for 1 second before
its execution. On the page, you will see the debug trace generated by Rod:

![trace](trace.png)

As you can see above the search button, Rod even creates a mock mouse cursor.

On console you will see the trace log like below:

```txt
[rod] 2020/11/11 02:42:30 [eval] {"js":"rod.element","params":["#searchInput"]}
[rod] 2020/11/11 02:42:31 [eval] {"js":"rod.visible","this":"input#searchInput"}
[rod] 2020/11/11 02:42:31 [input] scroll into view
[rod] 2020/11/11 02:42:31 [input] input earth
[rod] 2020/11/11 02:42:31 [eval] {"js":"rod.element","params":["#search-form > fieldset > button"]}
[rod] 2020/11/11 02:42:31 [eval] {"js":"rod.visible","this":"button.pure-button.pure-button-primary-progressive"}
[rod] 2020/11/11 02:42:31 [input] scroll into view
[rod] 2020/11/11 02:42:31 [input] left click
```
...
If we rerun the "main.go", we should see the console outputs something like:
