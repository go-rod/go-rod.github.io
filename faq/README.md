...
If needed, you can block certain resources (like images and fonts) from loading using the page function `HijackRequests()`

This is especially useful if you want to improve page loading times (especially if you're running on Headless Mode, since there is no point on loading fonts/css). Example below:
...
Code from: https://github.com/go-rod/rod/issues/195#issuecomment-682044949



## Manually setting the HTML content of a page

For now you have to use the `proto` package as seen below:
```golang
page := browser.MustPage()
proto.PageSetDocumentContent{
	FrameID: page.FrameID,
	HTML:    "<h1>test</h1>",
}.Call(page)
```

Code from: https://github.com/go-rod/rod/discussions/558#discussioncomment-2354880
